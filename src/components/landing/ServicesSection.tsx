...
export default function ServicesSection() {
  return (
    <section id="servicos" className="relative overflow-hidden py-16">
      <PawDecor />
      <div className="relative mx-auto max-w-5xl px-4">
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {PLACEHOLDER_SERVICES.map((service) => (
            <div
              key={service.name}
              className="rounded-xl border border-border bg-surface p-5 transition hover:border-accent hover:shadow-sm"
            >
